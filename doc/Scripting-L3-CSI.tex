...
\begin{document}
    ...
    \begin{frame}{Intervenant sur le module Scripting}{Christophe Brun, conseil en développement informatique}
        ...
        \begin{columns}
            \column{0.7\textwidth}
            \begin{itemize}
                \item 4\textsuperscript{ème} année d'intervenant à Saint-Michel \emoji{star-struck}.

                \item 7 ans de conseil en développement au sein d'SSII~.

                \item 9 ans de conseil en développement à mon compte \href{https://papit.fr}{PapIT}.
    ...
    \begin{frame}{Shell}{Pourquoi Shell et Bash dans le programme~?}
        Quel sens cela a-t-il~?
        \bigbreak
        \begin{figure}[htbp]
            \centering
            \includegraphics[width=10cm]{image/bashism.munge}
            \captionsetup{justification=centering, singlelinecheck=false}
            \caption{Thou shalt not suffer a bashism to live,\\ \protect\url{https://me.micahrl.com/blog/bashism/}}
        \end{figure}
        \pause
        \bigbreak
        Une \textit{cheatsheet} pour corriger les \textit{Bashism}, \url{https://mywiki.wooledge.org/Bashism}
    \end{frame}
...
ts-test
    ...
    \begin{frame}[fragile]{Shell}{Les alias}
        ...
        Ils sont donc intéressants à paramétrer pour les commandes longues et fréquentes.
        \bigbreak
...
5;"Brown";45;3000;2
        ...
        \begin{dangercolorbox}
            Les 2 doivent avoir exactement le même nombre de lignes~!
    ...
    \begin{frame}{Commandes de traitement de données}{Exercice \execcounterdispinc{}~:}
        \begin{footnotesize}
            ...
            \bigbreak
            Ces commandes ne remplacent pas SQL, car elles s'interfacent difficilement avec ces programmes hauts niveaux.
            \bigbreak
...
$ rsync -a utilisateur@serveur:/chemin/vers/mon-dossier/ /chemin/vers/mon-dossier/
    ...
    \begin{frame}{Scripts Shell}{Usages déconseillés}
        ...
        \begin{itemize}
            ...
            \item Des algorithmes complexes, car il n'éxiste aucun débuggeur sous Bash ou Shell natif sous Linux/Unix/Windows!
...
sys     0m0,006s
    ...
    \begin{frame}{Scripts Shell}{Outil de choix pour les scripts simples}
        ...
        \end{center}
        Ceci étant dit, sa syntaxe et son outillage simple en font un outil de scripting idéal pour tous.
...
8
    ...
    \begin{frame}[fragile]{Les différentes parenthèses en Bash\cref{penthesisbash}}{\lstinline{<<} Heredocs}
        \begin{itemize}
            \item Permet d'insérer du texte multiligne dans un script Bash.
            \item Utilisé pour les scripts ou les longs messages.
            \item Exemple :
            \begin{lstlisting}[language=bash]
$ cat <<EOF
Ceci est un texte
...
$ time <commande>
    ...
    \begin{frame}{Editeur Shell}{VS Code de Microsoft et ShellCheck}
        ...
        \bigbreak
        Pour le lancer tapez \textquote{code} dans la barre de recherche de Linux ou \lstinline{code .} dans un terminal pour le lancer dans le répertoire courant.
        \begin{itemize}
            \item Ouvrir VS Code.
    ...
    \begin{frame}[fragile]{Editeur Shell}{VS Code de Microsoft et ShellCheck}
        Les erreurs/warning apparaissent dans l'IDE VS Code.
        \begin{lstlisting}[language=bash,basicstyle=\tiny\ttfamily]
$ shellcheck fibo.ksh
...
^-----^ SC2154 (warning): valeur2 is referenced but not assigned.
    ...
    \begin{frame}{Editeurs Shell}{Exercice \execcounterdispinc}
        Cet exercice a pour but d'illustrer que les éditeurs fournissent une aide pour tout type de langage.
        \begin{itemize}
